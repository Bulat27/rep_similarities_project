...
from repsim.benchmark.types_globals import GOOD_CORA_DATASET_NAME
from repsim.benchmark.types_globals import GOOD_ARXIV_DATASET_NAME
...
GNN_PARAMS_DICT = {
    GCN_MODEL_NAME: {
        ...
        GOOD_ARXIV_DATASET_NAME: copy.deepcopy(GNN_PARAMS_DEFAULT_DICT),
        CORA_DATASET_NAME: {
    ...
    GAT_MODEL_NAME: {
        ...
        GOOD_ARXIV_DATASET_NAME: copy.deepcopy(GAT_PARAMS_DEFAULT_DICT),
        CORA_DATASET_NAME: {
            GNN_PARAMS_DIMENSION_KEY: 64,
            GNN_PARAMS_N_LAYERS_KEY: 2,
...
OPTIMIZER_PARAMS_DICT = {
    GCN_MODEL_NAME: {
        ...
        GOOD_ARXIV_DATASET_NAME: copy.deepcopy(OPTIMIZER_PARAMS_DEFAULT_DICT),
        CORA_DATASET_NAME: {
            OPTIMIZER_PARAMS_LR_KEY: OPTIMIZER_PARAMS_DEFAULT_LR,
...
DATASET_LIST = [ARXIV_DATASET_NAME, GOOD_ARXIV_DATASET_NAME, CORA_DATASET_NAME, GOOD_CORA_DATASET_NAME, FLICKR_DATASET_NAME, REDDIT_DATASET_NAME]
DEFAULT_DATASET_LIST = [CORA_DATASET_NAME, GOOD_ARXIV_DATASET_NAME, GOOD_CORA_DATASET_NAME, FLICKR_DATASET_NAME, ARXIV_DATASET_NAME]
